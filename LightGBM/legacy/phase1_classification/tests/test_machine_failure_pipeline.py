...
import legacy.phase1_classification.run_machine_failure_evaluation as pipeline_module

from legacy.phase1_classification.run_machine_failure_evaluation import (
    DEFAULT_DATA_PATH,
    FEATURE_COLUMNS,
    ...
    def test_cli_prints_train_and_test_metrics(self) -> None:
        ...
        result = {
            ...
            "pipeline_metadata": {
                "n_train": 8_000,
                "n_test": 2_000,
                "output_dir": Path("legacy/phase1_classification/outputs"),
            },
        }
        output = StringIO()
        with (
